...
\begin{frame}{Työtapa: mob programming + Claude}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item 2 päivää, $\sim$6 tuntia yhteensä
        \item 6 hengen ryhmä
    ...
    \begin{column}{0.48\textwidth}
      ...
      \end{itemize}
      \vspace{0.5em}
      \textbf{Ensimmäinen tehtävä istunnossa}
      \begin{itemize}
        \item \texttt{CLAUDE.md}:n ensimmäinen versio luotiin ennen ensimmäistäkään koodiriviä
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
  ...
  \begin{columns}
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faThumbsUp\ Toimi hyvin}
        \begin{itemize}
          \item Kevyen speksauksen jälkeen päästiin nopeasti toteutukseen
    ...
    \begin{column}{0.48\textwidth}
      \begin{alertblock}{\faExclamationTriangle\ Vaati huomiota}
        \begin{itemize}
          \item Projektion määrittely piti korjata käsin
...
\begin{frame}{Opit}
  \begin{enumerate}
    ...
    \item \textbf{Testit samaan tahtiin toteutuksen kanssa} \\
          Agentti kirjoittaa ja ajaa testit, sekä korjaa virheet itsenäisesti
    \item \textbf{Kysy äläkä hyväksy} \\
  ...
  \begin{columns}
    ...
    \begin{column}{0.42\textwidth}
      \begin{block}{}
        ...
        \small (hailathon)\\[1em]
        \large $\sim$6h \faArrowRight\ kokonainen toteutus\\
        \large + 158 testiä
        \vspace{0.5em}
      \end{block}
    \end{column}
