...
\title{Agenttiavusteinen mob-ohjelmointi}
  ...
  \begin{columns}
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        ...
        \item Tuottaa raeindeksikenttiä IRIS-tutkakomposiiteista
      ...
      \begin{itemize}
        ...
        \item Vastaava toiminnallisuus, luettava koodi
        \item Airflow-yhteensopiva Docker-kontti
        \item Tulosteet ODIM HDF5- ja COG-muodossa
      \end{itemize}
    \end{column}
    \begin{column}{0.42\textwidth}
      ...
      \begin{block}{Datavirta}
        \small
        ODIM TOPS (45/50 dBZ)\\
        + Säämallien isotermit (0\textdegree C, -20\textdegree C)\\
        $\downarrow$ \\
        POH, HHI, LHI, THI
      \end{block}
      \vspace{0.3em}
      \infobubble{%
        ...
        \textbf{HHI} Holleman Hail Index\\
        \textbf{LHI} Large Hail Index\\
        \textbf{THI} Tuovinen Hail Index
      }
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Työtapa: mob programming + Claude}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item 6 istuntoa, 13 tuntia yhteensä
        \item 3-6 hengen ryhmä
        \item \textbf{6 minuutin kierrot} — yksi näppäilijä kerrallaan
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item \texttt{AGENTS.md}:n ensimmäinen versio ennen ensimmäistäkään koodiriviä
...
% ─────────────────────────────────────────────────────────────────────────────
\begin{frame}{\texttt{AGENTS.md} — agentin kontekstidokumentti}
  \begin{columns}
    \begin{column}{0.52\textwidth}
      ...
      \begin{exampleblock}{}
        \small
        \faLightbulb\ Agentti lukee \texttt{AGENTS.md}:n kontekstiksi jokaisella kehotteella
      \end{exampleblock}
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{block}{Osa kolmentoista tunnin tuotoksia}
        \small
        \texttt{AGENTS.md} on osa repositoriota ja
...
% ─────────────────────────────────────────────────────────────────────────────
\begin{frame}{Mitä 13 tunnissa syntyi}
  \begin{columns}
    \begin{column}{0.52\textwidth}
      \textbf{Toteutus pähkinänkuoressa}
      \begin{itemize}
        \item Lukee TOPS-komposiitteja IRIS- ja ODIM-muodossa sekä NWP-isotermejä
        \item Laskee neljä raeindeksiä: \textbf{POH, HHI, LHI, THI}
        \item Kirjoittaa tulosteet ODIM HDF5- ja COG-muodossa
        \item Docker-kontitus
        \item Airflow DAG
      \end{itemize}
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{block}{Testikattavuus}
        \centering
        \Large \textbf{194 testiä}\\[0.3em]
        \normalsize
        yksikkö- ja integraatiotestit\\
        oikeilla IRIS- ja ODIM-tiedostoilla
      \end{block}
      \vspace{0.5em}
    ...
    \begin{column}{0.48\textwidth}
      \begin{exampleblock}{\faThumbsUp\ Toimi hyvin}
        \begin{itemize}
          ...
          \item Ymmärsi alan terminologian AGENTS.md:n pohjalta
...
\begin{frame}{Opit}
  \begin{enumerate}
    ...
    \item \textbf{AGENTS.md on tärkein yksittäinen investointi} \\
    ...
    \item \textbf{Substanssiosaaminen olennaista} \\
...
\begin{frame}{Yhteenveto}
  \begin{columns}
    \begin{column}{0.55\textwidth}
      \begin{block}{Tulos}
        \begin{itemize}
          \item Python-toteutus vanhan tuotantokoodin pohjalta \textbf{kuudessa istunnossa} (13~h) 3-6 hengen ryhmissä
          \item Ilman agenttiapua sama työ olisi kestänyt \emph{arviolta viikkoja}.
        \end{itemize}
      \end{block}
      \vspace{0.7em}
      \textbf{Seuraavat askeleet}
      \begin{itemize}
        \item Mallidata ASCII-tiedostojen sijaan Smartmet-serveriltä
        \item WMS-tasot ja validointi
        \item \textbf{Seuraavan tuotteen uudistus samalla tyylillä}
      \end{itemize}
    \end{column}
    \begin{column}{0.42\textwidth}
      \begin{block}{}
        ...
        \small (hailathon)\\[1em]
        \large 13h \faArrowRight\ kokonainen toteutus\\
        \large + 194 testiä\\
        \large + Airflow DAG
        \vspace{0.5em}
      \end{block}
...
\begin{frame}{}
  \centering
  \includegraphics[width=\textwidth,height=0.9\textheight,keepaspectratio]{questions}
\end{frame}
